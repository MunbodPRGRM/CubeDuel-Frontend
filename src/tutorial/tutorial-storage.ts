 ...
 *
 * ตั้งแต่ ADR-085 คู่มือเด้งเองเฉพาะบัญชีอายุไม่เกิน 24 ชั่วโมง — ที่เก็บนี้จึงมีไว้กันเด้งซ้ำ
 * **ภายใน 24 ชั่วโมงแรก** เท่านั้น (ค่า `practice:user:<id>` ของโค้ชห้องฝึกซ้อมที่ถอดไปแล้วอาจค้างอยู่ — ไม่มีใครอ่าน)
 */

const STORAGE_KEY = 'cubeduel.tutorial.v1';

/**
 * เลขรุ่นของ **เนื้อหา** ฝึกสอน — ขยับแล้วรายการ "ดูแล้ว" ถูกล้าง
 * ⚠️ **ไม่ได้ทำให้ทุกคนเห็นใหม่แล้ว** — มีผลแค่บัญชีอายุไม่เกิน 24 ชั่วโมง (ADR-085 ข้อ 1)
 * รื้อเนื้อหาใหญ่แล้วอยากให้คนเก่ารู้ ให้ประกาศผ่านข่าว (ปก `update`)
 */
